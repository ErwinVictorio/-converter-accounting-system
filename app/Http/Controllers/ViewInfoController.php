        ...
        return [
            ...
            'sections' => [
                ...
                $this->section('Purchase Classification and Amounts', [
                    ...
                    $this->field('purchase_local', 'Purchase Local', $displayAmounts['display_purchase_local_amount'], 'money'),
                    ...
                    $this->field('others', 'Others', $displayAmounts['display_others_amount'], 'money'),
